    ...
    <section class="account">
        <div class="account-area">
            <div class="account-wrapper">
                ...
                <form class="account-form" action="{{ setRoute('user.password.reset.submit',$token) }}" method="POST">
                    @csrf
                    <div class="row ml-b-20">
                        ...
                        <div class="col-lg-12 form-group text-center">
                            <button type="submit" class="btn--base w-100 btn-loading">{{ __("Reset") }} <i class="las la-arrow-right"></i></button>
                        </div>
                        <div class="or-area">
