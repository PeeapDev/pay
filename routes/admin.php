...
Route::group(['middleware' => ['guest:admin', 'locale', 'ip_middleware']], function ()
{
    ...
    Route::get('crypto-sent-transactions/pdf', 'CryptoSentTransactionController@cryptoSentTransactionsPdf')->name('admin.crypto_sent_transaction.pdf');
    Route::get('crypto-sent-transactions/view/{id}', 'CryptoSentTransactionController@view')->name('admin.crypto_sent_transaction.view')->middleware('permission:view_crypto_transactions');
    Route::get('crypto-sent-transactions/search/user', 'CryptoSentTransactionController@cryptoSentTransactionsSearchUser')->name('admin.crypto_sent_transaction.search_user');

    // Crypto Receive Transactions
    Route::get('crypto-received-transactions', 'CryptoReceivedTransactionController@index')->name('admin.crypto_received_transaction.index')->middleware('permission:view_crypto_transactions');
    Route::get('crypto-received-transactions/csv', 'CryptoReceivedTransactionController@cryptoReceivedTransactionsCsv')->name('admin.crypto_received_transaction.csv');
    Route::get('crypto-received-transactions/pdf', 'CryptoReceivedTransactionController@cryptoReceivedTransactionsPdf')->name('admin.crypto_received_transaction.pdf');
    Route::get('crypto-received-transactions/view/{id}', 'CryptoReceivedTransactionController@view')->name('admin.crypto_received_transaction.view')->middleware('permission:view_crypto_transactions');
    Route::get('crypto-received-transactions/search/user', 'CryptoReceivedTransactionController@cryptoReceivedTransactionsSearchUser')->name('admin.crypto_received_transaction.search_user');
